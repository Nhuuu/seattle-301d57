...
// "this" bubbles up to the window object therefore is undefined, it is not enclosed in a scope.
// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" here is the same as joe.scope() in which it becomes undefined.
// 3. Explain why "this" is different when an arrow function is used.
// Because arrow functions do not bind "this" so it bubbles up to the next-nearest enclosed scope, and since these both are not in any other enclosed scope other than the global window object, it cannot define the object of "this"
